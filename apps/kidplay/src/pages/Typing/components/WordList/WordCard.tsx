...
export default function WordCard({ word, isActive, index }: { word: Word; isActive: boolean; index: number }) {
    ...
    >
      <div className="flex-1">
        <p className="select-all font-mono text-xl font-normal leading-6 dark:text-gray-50">
          {index + 1}. {['romaji', 'hapin'].includes(currentLanguage) ? word.notation : word.name}
        </p>
